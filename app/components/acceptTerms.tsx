    ...
    <Card>
      ...
      <CardContent>
        ...
        <ul className="list-disc list-inside">
          <li>
            <span>
              You <strong>MUST NOT</strong> use this app to estimate when you may be below a
              drink-driving limit, or safe to operate heavy machinery, etc.
            </span>
          </li>
          <li>
            <span>
              This app <strong>MUST NOT</strong> be used for any purpose other than out of personal
              curiosity. The numbers it creates are at best guesses.
            </span>
          </li>
          <li>
            <span>
              You <strong>MUST NOT</strong> rely on this app for making decisions.
            </span>
          </li>
      ...
      <CardFooter className="flex justify-center">
        <Button
          onClick={() => {
            if (me) me.root.$jazz.set("hasAcceptedTerms", true);
          }}
        >
