...
describe("useAcceptInvite", () => {
    it("should accept the invite", async () => {
        ...
        let acceptedId;
        const invitelink = createInviteLink(TestMap.create({ value: "hello" }, { owner: Group.create({ owner: inviteSender }) }), "reader");
        location.href = invitelink;
        renderHook(() => useAcceptInvite({
...
//# sourceMappingURL=useAcceptInvite.test.js.map