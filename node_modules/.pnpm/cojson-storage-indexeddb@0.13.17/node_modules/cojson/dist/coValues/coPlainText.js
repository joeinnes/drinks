...
export function stringifyOpID(opID) {
 ...
 * ```
 */
export class RawCoPlainText extends RawCoList {
    constructor(core) {
        super(core);
        /** @category 6. Meta */
        ...
        const effectiveLocale = (core.header.meta &&
            typeof core.header.meta === "object" &&
            "locale" in core.header.meta
            ? core.header.meta.locale
            : undefined) ||
...
//# sourceMappingURL=coPlainText.js.map