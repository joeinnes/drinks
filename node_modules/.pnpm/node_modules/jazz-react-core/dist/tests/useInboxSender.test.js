...
describe("useInboxSender", () => {
    it("should send the message to the inbox", async () => {
        ...
        const { result } = renderHook(() => experimental_useInboxSender(inboxReceiver.id), {
            account,
        });
        const sendMessage = result.current;
        const promise = sendMessage(TestMap.create({ value: "hello" }, { owner: Group.create({ owner: account }) }));
...
//# sourceMappingURL=useInboxSender.test.js.map