...
test("throws an error if the user tried to create an invite from an account owned coValue", async () => {
    ...
    expect(() => createInviteLink(map, "admin", { baseURL: "http://localhost:3000" })).toThrow("Can't create invite link for object without group");
});
//# sourceMappingURL=createInviteLink.test.js.map