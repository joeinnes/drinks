...
export async function setupTwoNodes() {
    const [serverAsPeer, clientAsPeer] = cojsonInternals.connectedPeers("clientToServer", "serverToClient", {
        peer1role: "server",
        peer2role: "client",
    });
    ...
    return {
        ...
        clientAccount: Account.fromRaw(await loadCoValueOrFail(client.node, client.accountID)),
        serverAccount: Account.fromRaw(await loadCoValueOrFail(server.node, server.accountID)),
    };
}
