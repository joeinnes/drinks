...
describe("BrowserPasskeyAuth", () => {
    ...
    const mockCrypto = {
        ...
        agentSecretFromSecretSeed: () => "mock-secret",
    };
    ...
    describe("initialization", () => {
        it("should initialize with default hostname", () => {
            const auth = new BrowserPasskeyAuth(mockCrypto, mockAuthenticate, authSecretStorage, "Test App");
        ...
        it("should initialize with custom hostname", () => {
            const auth = new BrowserPasskeyAuth(mockCrypto, mockAuthenticate, authSecretStorage, "Test App", "custom.host");
    ...
    describe("authentication flows", () => {
        ...
        it("should handle passkey errors during login", async () => {
            const auth = new BrowserPasskeyAuth(mockCrypto, mockAuthenticate, authSecretStorage, "Test App");
            mockNavigator.credentials.get.mockRejectedValue(new Error("User rejected the passkey"));
            await expect(auth.logIn()).rejects.toThrow("Passkey creation aborted");
        });
        it("should handle passkey errors during signup", async () => {
            const auth = new BrowserPasskeyAuth(mockCrypto, mockAuthenticate, authSecretStorage, "Test App");
            mockNavigator.credentials.create.mockRejectedValue(new Error("User rejected the passkey"));
            // Set up existing credentials in storage
            await authSecretStorage.set({
                accountID: "test123",
                secretSeed: new Uint8Array([1, 2, 3]),
            ...
            await expect(auth.signUp("testuser")).rejects.toThrow("Passkey creation aborted");
        });
...
//# sourceMappingURL=PasskeyAuth.test.js.map