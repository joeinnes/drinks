...
describe("usePassphraseAuth", () => {
    ...
    it("throws error when using guest account", async () => {
        ...
        expect(() => renderHook(() => usePassphraseAuth({ wordlist: testWordlist }), {
            account: guestAccount,
        })).toThrow();
    });
    it("should show signed in state with authenticated account", async () => {
        const { result } = renderHook(() => usePassphraseAuth({ wordlist: testWordlist }), {
    ...
    it("should sign up with the current credentials", async () => {
        ...
        expect(mnemonicToEntropy(passphrase, testWordlist)).toEqual(credentialsBefore?.secretSeed);
    });
...
//# sourceMappingURL=usePassPhraseAuth.test.js.map