...
export declare class BrowserPasskeyAuth {
    ...
    appName: string;
    appHostname: string;
    constructor(crypto: CryptoProvider, authenticate: AuthenticateAccountFunction, authSecretStorage: AuthSecretStorage, appName: string, appHostname?: string);
...
//# sourceMappingURL=PasskeyAuth.d.ts.map