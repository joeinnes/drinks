...
async function exportAccountToInspector() {
    ...
    window.open(new URL(`#/import/${localStorageData?.accountID}/${encodedAccountSecret}`, "https://inspector.jazz.tools").toString(), "_blank");
}
...
//# sourceMappingURL=export-account-inspector.js.map