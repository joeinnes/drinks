...
test("should throw on creation if Intl.Segmenter is not available", () => {
    ...
    expect(() => group.createPlainText()).toThrow("Intl.Segmenter is not supported. Use a polyfill to get coPlainText support in Jazz. (eg. https://formatjs.github.io/docs/polyfills/intl-segmenter/)");
});
...
//# sourceMappingURL=coPlainText.test.js.map