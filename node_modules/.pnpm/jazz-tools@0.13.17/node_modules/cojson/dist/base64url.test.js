...
test("Test our Base64 URL encoding and decoding", () => {
    ...
    expect(base64URLtoBytes("V2hhdCBkb2VzIDIgKyAyLjEgZXF1YWw_PyB-IDQ=")).toEqual(txt.encode("What does 2 + 2.1 equal?? ~ 4"));
    // reverse
    expect(bytesToBase64url(txt.encode("What does 2 + 2.1 equal?? ~ 4"))).toEqual("V2hhdCBkb2VzIDIgKyAyLjEgZXF1YWw_PyB-IDQ=");
});
